export default class SocialEdit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      facebookUrl: this.props.organization.facebookUrl,
      linkedinUrl: this.props.organization.linkedinUrl,
      twitterUrl:  this.props.organization.twitterUrl,
    }
  }
  ...
  backendUpdateContact() {
    ...
    http.put(this.props.organizationPath, params, () => {
